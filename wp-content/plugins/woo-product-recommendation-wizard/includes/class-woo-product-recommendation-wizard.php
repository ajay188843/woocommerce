...
class Woo_Product_Recommendation_Wizard {
    ...
    private function define_admin_hooks() {
        ...
        $this->loader->add_action('wp_ajax_get_question_list_with_pagination', $plugin_admin, 'get_question_list_with_pagination');
        $this->loader->add_action('wp_ajax_nopriv_get_question_list_with_pagination', $plugin_admin, 'get_question_list_with_pagination');
    }
